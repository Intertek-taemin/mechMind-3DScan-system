...
class MainWindow(QMainWindow):
    ...
    def _build_central_views(self):
        ...
        left_layout.addWidget(self.compare_viewer)
        ...
        right_layout.addWidget(self.scan_viewer)
    ...
    def _build_log_dock(self):
        ...
        # (선택) 최초 비율을 좀 더 반반에 가깝게
        try:
            self.resizeDocks([dock, dock_cam], [600, 600], Qt.Horizontal)
        except Exception:
            pass
