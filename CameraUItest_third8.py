...
from PySide6.QtCore import Qt, QObject, Signal, QThread, QEvent, QTimer, QPoint, QAbstractTableModel, QModelIndex
...
# ============================================================
# Excel Log Viewer (QTableView) + Log Picker Dialog
# ============================================================
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # ✅ NEW: Watch Today's Log 버튼
        self.btn_watch_today_log = QPushButton("Watch Today's Log")
        self.btn_watch_today_log.setStyleSheet(btn_style)
        self.btn_watch_today_log.clicked.connect(self.on_watch_today_log_clicked)
        top2_layout.addWidget(self.btn_watch_today_log)

        # ✅ NEW: Load Other Log 버튼
        self.btn_load_other_log = QPushButton("Load Other Log")
        self.btn_load_other_log.setStyleSheet(btn_style)
        self.btn_load_other_log.clicked.connect(self.on_load_other_log_clicked)
        top2_layout.addWidget(self.btn_load_other_log)
