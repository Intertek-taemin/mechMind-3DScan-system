...
class MainWindow(QMainWindow):
    ...
    def _build_log_dock(self):
        ...
        btn_clear_log.clicked.connect(self.on_refresh_clicked)
        top.addWidget(btn_clear_log)
    ...
    def _sync_top_labels(self):
        ...
        if hasattr(self, "gb_compare") and self.gb_compare:
            self.gb_compare.setTitle(f"저장된 비교 대상   (Compare: {cmp})")
        if hasattr(self, "gb_recent") and self.gb_recent:
            self.gb_recent.setTitle(f"가장 최근에 촬영된 이미지   (Last: {last})")
